...
output "KeyVaultAccessPolicy_DatabricksAdmin_Id" {
  value             = module.KeyVaultAccessPolicy_DatabricksAdmin.Id
  sensitive         = true
}

output "KeyVaultAccessPolicy_DatabricksAdmin_KeyVaultId" {
  value             = module.KeyVaultAccessPolicy_DatabricksAdmin.KeyVaultId
  sensitive         = true
}

output "KeyVaultAccessPolicy_DatabricksAdmin_KeyVaultAcccessPolicyFullOutput" {
  value             = module.KeyVaultAccessPolicy_DatabricksAdmin.KeyVaultAcccessPolicyFullOutput
  sensitive         = true
}
...
output "CertId" {
  value               = module.Cert_Wildcard.*.Id
  sensitive           = true
}

output "CertFull" {
  value               = module.Cert_Wildcard.*.Full
  sensitive           = true
}

output "Cert1Name" {
  value               = module.Cert_Wildcard[0].Full.name
  sensitive           = true
}
